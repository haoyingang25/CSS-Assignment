...
//recipe/japanese/japanese-pancakes/page.jsx
"use client";
...
const JapanesePancakesRecipe = {
    ...
    steps: [
        "Separate the eggs: Carefully separate the egg yolks and egg whites into two bowls.",
        "Prepare the batter: In a bowl, whisk together egg yolks, milk, and vanilla extract. Sift in the flour and baking powder, then mix until smooth.",
        "Whip the egg whites: Beat the egg whites until foamy, then gradually add sugar while continuing to beat until stiff peaks form.",
        "Fold the egg whites: Gently fold the whipped egg whites into the batter in small portions, taking care not to deflate the mixture.",
        "Cook the pancakes: Heat a non-stick skillet over low heat and lightly grease with butter. Using a ring mold, pour the batter into the mold to form tall pancakes. Cover and cook for 4-5 minutes on each side until golden brown and cooked through.",
        "Serve: Remove the pancakes from the mold and serve immediately with syrup, whipped cream, and fresh fruit."
    ],
};
    ...
    return (
        <div className={styles.container}>
            <div className={styles.card}>
                <h1>Japanese Pancakes Recipe</h1>
...
export default function Home() {
    return (
        <div className={styles.container}>
            <RecipeCard recipe={JapanesePancakesRecipe} />
        </div>
    );
}
