...
const PizzaRecipe = {
    ingredients: [
        ...
        { name: "Water", amount: 150, unit: "milliliters" },
        ...
        { name: "Pepperoni", amount: 100, unit: "grams" },
        { name: "Basil Leaves", amount: 10, unit: "pieces" },
        { name: "Olives", amount: 50, unit: "grams" },
    ],
    steps: [
        "Prepare the Dough: Mix flour, water, yeast, olive oil, salt, and sugar to form a dough. Knead for 5-10 minutes until smooth. Let it rise for 1-2 hours.",
        "Prepare the Sauce: In a small saucepan, simmer tomato sauce until thickened. Season with salt, pepper, and any herbs you like.",
        "Preheat Oven: Preheat your oven to 220 degrees celcius (430 fahrenheit).",
        "Assemble the Pizza: Roll out the dough into a thin circle. Spread the tomato sauce evenly, add cheese, pepperoni, olives, and basil leaves.",
        "Bake the Pizza: Place the pizza in the oven and bake for 10-15 minutes or until the crust is golden and the cheese is bubbly.",
        "Serving: Remove from the oven, slice, and serve hot.",
    ],
};
