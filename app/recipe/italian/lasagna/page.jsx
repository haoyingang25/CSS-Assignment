...
//recipe/italian/lasanga/page.jsx
"use client";
...
const LasagnaRecipe = {
    ingredients: [
        ...
        { name: "Mozzarella Cheese (shredded)", amount: 300, unit: "grams" },
        { name: "Parmesan Cheese (grated)", amount: 100, unit: "grams" },
        { name: "Tomato Sauce", amount: 400, unit: "milliliters" },
        { name: "Garlic (minced)", amount: 3, unit: "cloves" },
        { name: "Onion (chopped)", amount: 1, unit: "piece" },
        { name: "Olive Oil", amount: 2, unit: "tablespoons" },
        { name: "Egg", amount: 1, unit: "piece" },
        { name: "Basil (fresh, chopped)", amount: 2, unit: "tablespoons" },
        { name: "Oregano", amount: 1, unit: "teaspoons" },
        { name: "Salt", amount: 1, unit: "teaspoons" },
        { name: "Pepper", amount: 1, unit: "teaspoons" },
    ],
    steps: [
        "Cook the Lasagna Noodles: Boil the lasagna noodles according to package instructions. Drain and set aside.",
        "Prepare the Meat Sauce: Heat olive oil in a pan, add chopped onion and minced garlic, and saute until softened. Add ground beef, cook until browned, then add tomato sauce, salt, pepper, basil, and oregano. Simmer for 10 minutes.",
        "Prepare the Cheese Mixture: In a bowl, mix ricotta cheese, egg, and half of the grated Parmesan cheese. Set aside.",
        "Assemble the Lasagna: In a baking dish, layer noodles, meat sauce, ricotta mixture, and mozzarella cheese. Repeat layers until all ingredients are used, finishing with mozzarella cheese on top.",
        "Bake the Lasagna: Preheat the oven to 180 degrees celcius (350 fahrenheit). Cover the baking dish with foil and bake for 30 minutes. Remove the foil and bake for another 10 minutes until the cheese is golden and bubbly.",
        "Serve: Let the lasagna cool for 10 minutes before cutting into slices and serving.",
    ],
};
...
export default function Home() {
    return (
        <div className={styles.container}>
            <RecipeCard recipe={LasagnaRecipe} />
        </div>
    );
}
